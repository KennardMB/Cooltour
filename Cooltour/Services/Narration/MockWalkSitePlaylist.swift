...
/// Preview/test double — same behaviour as `WalkSitePlaylistService`, kept separate so production
/// wiring stays obvious in `CooltourApp`.
@Observable
final class MockWalkSitePlaylist: WalkSitePlaylist {
